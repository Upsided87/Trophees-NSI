...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        super().__init__()
        # Chemin vers le dossier data/images depuis la racine du projet
        base_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        self.sprite_sheet = pygame.image.load(
            os.path.join(base_dir, 'data', 'images', 'drone_spritesheet.png')
        )
    ...
    def update(self):
        """Met à jour le rectangle principal et le rectangle des pieds."""
